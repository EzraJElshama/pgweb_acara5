...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link size="" name="SDE Feature Class" url="Server=gisserver_skala_250K; Service=sde:sqlserver:gisserver\skala_250K; Database=Indonesia_250K; Version=dbo.DEFAULT" mimeType="" format="" description="" type="ArcSDE Connection"/>
  </links>
  <dates/>
  <fees></fees>
